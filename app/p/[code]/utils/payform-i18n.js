const PAYFORM_MESSAGES = {
    en: {
        ...
        amountLabel: 'How much are you paying?',
        minimumDonation: 'Minimum donation: {amount}',
        collectedSoFar: 'Collected so far',
        totalToPay: 'Total to pay',
        amount: 'Amount',
        howToPay: 'Pay via',
        fondekaAppPaymentTitle: 'Fondeka app',
        payWithFondeka: 'Pay with Fondeka',
        fondekaAppInstallFallback: 'Fondeka app not installed? Download the app to pay with your Fondeka balance.',
    ...
    fr: {
        ...
        amountLabel: 'Vous payez combien ?',
        minimumDonation: 'Don minimum : {amount}',
        collectedSoFar: 'Montant collecté',
        totalToPay: 'Total à payer',
        amount: 'Montant',
        howToPay: 'Payer via',
        fondekaAppPaymentTitle: 'Application Fondeka',
        payWithFondeka: 'Pay with Fondeka',
        fondekaAppInstallFallback: 'Fondeka app not installed? Download the app to pay with your Fondeka balance.',
